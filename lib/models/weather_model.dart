...
class WeatherModel {
  ...
  factory WeatherModel.fromJson(Map<String, dynamic> json) {
    ...
    grouped.forEach((date, entries) {
      ...
      final rep = entries.firstWhere((e) => (e['dt_txt'] as String).contains('12:00:00'), orElse: () => entries[0]);
      ...
      daily.add(DailyForecast(
        ...
        sunrise: citySunrise != null ? DateTime.fromMillisecondsSinceEpoch(citySunrise * 1000) : null,
        sunset: citySunset != null ? DateTime.fromMillisecondsSinceEpoch(citySunset * 1000) : null,
